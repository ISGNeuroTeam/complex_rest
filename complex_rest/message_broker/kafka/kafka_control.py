...
from kafka.errors import InvalidPartitionsError, KafkaError, GroupCoordinatorNotAvailableError
...
class KafkaControl:
    ...
    def partitions_auto_increment(self, topic, consumer_group):
        ...
        except GroupCoordinatorNotAvailableError as err:
            # this error occurs when first consumer is being created because group coordinator doesn't exist
            pass
