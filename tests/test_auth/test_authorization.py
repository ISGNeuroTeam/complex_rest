...
class TestKeyChain(TestCase):
    ...
    def test_user_specified_default_keychain_id(self):
        ...
        test_object = ProtectedObject()
        self.assertEqual(_get_obj_keychain_id(test_object), f'test_auth.test_authorization.{user_specified_keychain_id}')
    ...
    def test_keychain_property(self):
        ...
        test_object = ProtectedObject()
        self.assertEqual(_get_obj_keychain_id(test_object), 'test_auth.test_authorization.ProtectedObject.10')
